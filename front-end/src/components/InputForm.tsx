  ...
  return (
    <div className="container mt-5">
      <div className="card p-4">
        <h5 className="card-title">Was this text written by a <strong>human</strong> or <strong>AI</strong>?</h5>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="d-flex justify-content-between align-items-center mt-3">
            ...
            <button type="button" className="btn btn-link">UPGRADE</button>
          </div>
          <div className="d-flex justify-content-between align-items-center mt-3">
            <button type="submit" className="btn btn-dark">Check Origin</button>
            <div className="form-group">
              <label className="btn btn-outline-secondary">
                Upload file <input type="file" hidden onChange={handleFileChange} />
              </label>
              {file && <small className="text-muted">{file.name}</small>}
            </div>
          </div>
          <p className="mt-3">By continuing you agree to our <a href="/terms">Terms of service</a></p>
        </form>
      </div>
    </div>
  );
