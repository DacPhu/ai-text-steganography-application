...
const Dropbox = () => {
    ...
    const handleDetectImage = async () => {
        if (uploadedImage) {
            ...
            try {
                ...
                // // Chuyển đổi hình ảnh thành FormData để gửi tới backend
    ...
    return (
        <div className=" p-xl-2 border-3  bg-white mt-5 d-flex flex-column align-items-center p-3 rounded-2" style={{ height: "70vh" }}  >
            <h1 className=" text-black">Detect Image Generated By Ai</h1>
            {uploadedImage ? (
                <>
                    <div className="d-flex flex-column flex-md-row h-100 w-100 flex-row" >
